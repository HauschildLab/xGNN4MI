"""
Helper functions for loading ECG recordings and constructing patch-based graphs.

Includes utilities for:
    - locating ECG records
    - loading signals using WFDB
    - constructing graph structures from ECG patches
"""
