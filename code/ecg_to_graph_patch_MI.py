"""
Create graph representations of ECG signals for myocardial infarction (MI) classification.

The script converts PTB-XL ECG recordings into patch-based graph structures.
Only selected MI subclasses (and optionally NORM) are included as target labels.

Graphs are saved as PyTorch Geometric Data objects for downstream GNN training.
"""
...
class GraphDataset(Dataset):
    ...
    def processed_dir(self):
        return osp.join(self.root, f'processed_patch{self.num_patches}_MI_Norm')
